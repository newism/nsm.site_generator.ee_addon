	...
	<table class="data">
		<tbody>
			<tr>
				...
				<td><?= lang("msg.warning.truncate_db")?>d</td>
				<td><?= Nsm_site_generator_addon::yesNoRadioGroup("{$input_prefix}['options']['general'][truncate_db]", FALSE); ?></td>
			</tr>
		</tbody>
	</table>
</div>
...
<div class="tg" id="channels">
	<h2>2. Which channels would you like to import?</h2>
